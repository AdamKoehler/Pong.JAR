...
public class GamePanel extends JPanel implements Runnable{
	...
	public void move() {
		// THIS CAN BE CHANGED TO MAKE THE GAME TWO PLAYER
		// paddle2.move(); will allow player 2 to use arrow keys and removes "bot"
		paddle1.move();
		paddle2.y = ball.y;
		ball.move();
	}
	...
	public void run() {
		// alot of AWT methods here that required some learning. basically run refreshes the graphic using an infinite loop.
		// regular infinite loop is not fast enough must use System.nanoTime().
